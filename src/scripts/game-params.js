...
export const PERK = {
  ...
  ROUND_LENGTH: 6,
  ROUNDS: {
    0: {NAME: 'FIRST ROUND', MEDPAKS: 0, AMMO: 2, NOS: 4, LIGHTNING: 1},
    1: {NAME: 'SECOND ROUND', MEDPAKS: 1, AMMO: 4, NOS: 4, LIGHTNING: 0},
    2: {NAME: 'THIRD ROUND', MEDPAKS: 2, AMMO: 6, NOS: 4, LIGHTNING: 1},
    3: {NAME: 'LIGHTNING ROUND', MEDPAKS: 1, AMMO: 5, NOS: 4, LIGHTNING: 4},
    4: {NAME: 'FIFTH ROUND', MEDPAKS: 1, AMMO: 2, NOS: 4},
    5: {NAME: 'SIXTH ROUND', MEDPAKS: 2, AMMO: 10, NOS: 4},
    6: {NAME: 'SEVENTH ROUND', MEDPAKS: 3, AMMO: 15, NOS: 4},
    7: {NAME: 'EIGHT ROUND', MEDPAKS: 8, AMMO: 40, NOS: 4},
    8: {NAME: 'PERPETUITY ROUND', MEDPAKS: 2, AMMO: 20, NOS: 4}
  }
}
